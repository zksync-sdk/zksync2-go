...
func bindIZkSync(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(IZkSyncABI))
	if err != nil {
		return nil, err
	}
...
// GetpriorityTxMaxGasLimit is a free data retrieval call binding the contract method 0x2cc8412a.
//
...
// SerializeL2Transaction is a free data retrieval call binding the contract method 0xf36dc915.
//
// Solidity: function serializeL2Transaction(uint256 _txId, uint256 _l2Value, address _sender, address _contractAddressL2, bytes _calldata, uint256 _l2GasLimit, uint256 _l2GasPerPubdataByteLimit, bytes[] _factoryDeps, uint256 _toMint, address _refundRecipient) pure returns((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[4],bytes,bytes,uint256[],bytes,bytes))
func (_IZkSync *IZkSyncCaller) SerializeL2Transaction(opts *bind.CallOpts, _txId *big.Int, _l2Value *big.Int, _sender common.Address, _contractAddressL2 common.Address, _calldata []byte, _l2GasLimit *big.Int, _l2GasPerPubdataByteLimit *big.Int, _factoryDeps [][]byte, _toMint *big.Int, _refundRecipient common.Address) (IMailboxL2CanonicalTransaction, error) {
	var out []interface{}
	err := _IZkSync.contract.Call(opts, &out, "serializeL2Transaction", _txId, _l2Value, _sender, _contractAddressL2, _calldata, _l2GasLimit, _l2GasPerPubdataByteLimit, _factoryDeps, _toMint, _refundRecipient)

	if err != nil {
		return *new(IMailboxL2CanonicalTransaction), err
	}

	out0 := *abi.ConvertType(out[0], new(IMailboxL2CanonicalTransaction)).(*IMailboxL2CanonicalTransaction)
...
//
// Solidity: function serializeL2Transaction(uint256 _txId, uint256 _l2Value, address _sender, address _contractAddressL2, bytes _calldata, uint256 _l2GasLimit, uint256 _l2GasPerPubdataByteLimit, bytes[] _factoryDeps, uint256 _toMint, address _refundRecipient) pure returns((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[4],bytes,bytes,uint256[],bytes,bytes))
func (_IZkSync *IZkSyncSession) SerializeL2Transaction(_txId *big.Int, _l2Value *big.Int, _sender common.Address, _contractAddressL2 common.Address, _calldata []byte, _l2GasLimit *big.Int, _l2GasPerPubdataByteLimit *big.Int, _factoryDeps [][]byte, _toMint *big.Int, _refundRecipient common.Address) (IMailboxL2CanonicalTransaction, error) {
	return _IZkSync.Contract.SerializeL2Transaction(&_IZkSync.CallOpts, _txId, _l2Value, _sender, _contractAddressL2, _calldata, _l2GasLimit, _l2GasPerPubdataByteLimit, _factoryDeps, _toMint, _refundRecipient)
}

// SerializeL2Transaction is a free data retrieval call binding the contract method 0xf36dc915.
//
// Solidity: function serializeL2Transaction(uint256 _txId, uint256 _l2Value, address _sender, address _contractAddressL2, bytes _calldata, uint256 _l2GasLimit, uint256 _l2GasPerPubdataByteLimit, bytes[] _factoryDeps, uint256 _toMint, address _refundRecipient) pure returns((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[4],bytes,bytes,uint256[],bytes,bytes))
func (_IZkSync *IZkSyncCallerSession) SerializeL2Transaction(_txId *big.Int, _l2Value *big.Int, _sender common.Address, _contractAddressL2 common.Address, _calldata []byte, _l2GasLimit *big.Int, _l2GasPerPubdataByteLimit *big.Int, _factoryDeps [][]byte, _toMint *big.Int, _refundRecipient common.Address) (IMailboxL2CanonicalTransaction, error) {
	return _IZkSync.Contract.SerializeL2Transaction(&_IZkSync.CallOpts, _txId, _l2Value, _sender, _contractAddressL2, _calldata, _l2GasLimit, _l2GasPerPubdataByteLimit, _factoryDeps, _toMint, _refundRecipient)
}
