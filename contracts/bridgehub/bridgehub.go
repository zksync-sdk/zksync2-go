...
// GetStateTransition is a free data retrieval call binding the contract method 0xc2570620.
//
// Solidity: function getStateTransition(uint256 _chainId) view returns(address)
func (_IBridgehub *IBridgehubCaller) GetStateTransition(opts *bind.CallOpts, _chainId *big.Int) (common.Address, error) {
	var out []interface{}
	err := _IBridgehub.contract.Call(opts, &out, "getStateTransition", _chainId)
...
//
// Solidity: function getStateTransition(uint256 _chainId) view returns(address)
func (_IBridgehub *IBridgehubSession) GetStateTransition(_chainId *big.Int) (common.Address, error) {
	return _IBridgehub.Contract.GetStateTransition(&_IBridgehub.CallOpts, _chainId)
}

// GetStateTransition is a free data retrieval call binding the contract method 0xc2570620.
//
// Solidity: function getStateTransition(uint256 _chainId) view returns(address)
func (_IBridgehub *IBridgehubCallerSession) GetStateTransition(_chainId *big.Int) (common.Address, error) {
	return _IBridgehub.Contract.GetStateTransition(&_IBridgehub.CallOpts, _chainId)
}
